                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="./EditarUsuarioControlador" method="POST">
                                ...
                                <input type="text" readonly style="border:none; background: none; display: none;"
                                ...
                                <span style="display: inline-block;">
                                    <p style="font-size: 30px" id="nombre"><%= usuario.getNombre() %></p>
                                <input
                                    style="display: none"
                                    type="text"
                                    name="editNombre"
                                    ...
                                    placeholder="Nombre"
                                    />
                                    <p style="font-size: 30px;" id="apellido"><%= usuario.getApellido()%></p>
                                <input
                                    style="display: none"
                                    type="text"
                                    name="editApellido"
